    ...
    <section id="about" className="py-20 border-t border-white/5">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <h2 className="text-3xl font-bold mb-6">Founder Mindset, Product Execution</h2>
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="glass rounded-3xl p-8 aspect-square flex flex-col justify-center gap-8 glow-blue"
        >
          <div className="flex gap-4 items-start">
            <div className="w-12 h-12 rounded-2xl bg-blue-500/20 border border-blue-500/30 flex items-center justify-center text-blue-400 font-bold shrink-0">01</div>
            <div>
          ...
          <div className="flex gap-4 items-start">
            <div className="w-12 h-12 rounded-2xl bg-emerald-500/20 border border-emerald-500/30 flex items-center justify-center text-emerald-400 font-bold shrink-0">02</div>
            <div>
              <h3 className="font-semibold text-lg mb-1">Leverage</h3>
              <p className="text-sm text-slate-400">Focusing effort on high-impact bottlenecks that move the needle for product and finance systems.</p>
            </div>
          </div>
          <div className="flex gap-4 items-start">
            <div className="w-12 h-12 rounded-2xl bg-blue-500/20 border border-blue-500/30 flex items-center justify-center text-blue-400 font-bold shrink-0">03</div>
            <div>
